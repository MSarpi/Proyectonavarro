...
import '../../estilos/StyleModalWhatsapp.css'
...
export default function WhatsappModal({btnText, btnBackground, btnColorText, empresa, colorEmpresa, celular, mensaje, btnRespuesta, textEnlace, sizeY, sizeX, bgColorTop, bgColorBottom }) {
  ...
  return (
    <>
        <div>
            <a className="btn-cotizar" style={{ color: btnColorText, background: btnBackground }} onClick={handleModalToggle}><strong className="strong-btn-creaciones-navarro">{btnText}</strong></a>
        </div>


        <div className={` ${modalWhatsappOn ? 'modal-whatsapp-on' : 'modal-whatsapp-off'}`}>
            <div className="card-whatsapp-npm">
                <div role="alert" aria-live="assertive" aria-atomic="true" style={{ width: sizeX }}>
                    <div className="header-whatsapp-npm" style={{ backgroundColor: bgColorTop}}>
                        <div className="header-content-whatsapp-npm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="modal-svg-creaciones-navarro" viewBox="0 0 16 16">
